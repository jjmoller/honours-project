...
initial_clean_data %>% 
  ...
  geom_vline(xintercept = as.numeric(as.Date("2020-03-11")), linetype=4, color="orange")+
...
#ggsave("sentiment_boxplot_with_zoom.png", width=14, height=7, dpi=500)
...
data_with_sentiment %>% select(website_category, ave_sentiment, week) %>% 
  ...
  geom_vline(xintercept = as.numeric(as.Date("2020-03-11")),color="orange", linetype=4)+
...
Sentiment difference by website category
```{r}
...
#ggsave("topics_with_sentiment.pdf", width=10, dpi=500)
```
...
data_topics_with_labels$topic[data_topics_with_labels$topic == "1"] <- "Skill development"
data_topics_with_labels$topic[data_topics_with_labels$topic == "2"] <- "Education"
data_topics_with_labels$topic[data_topics_with_labels$topic == "3"] <- "Parental concerns"
data_topics_with_labels$topic[data_topics_with_labels$topic == "4"] <- "General tech use"
data_topics_with_labels$topic[data_topics_with_labels$topic == "5"] <- "Gaming"
data_topics_with_labels$topic[data_topics_with_labels$topic == "6"] <- "Increased screentime"
...
data_topics_with_labels$topic[data_topics_with_labels$topic == "9"] <- "Social media effects on mental health"
data_topics_with_labels$topic[data_topics_with_labels$topic == "10"] <- "Mobile screentime effects"
data_topics_with_labels$topic[data_topics_with_labels$topic == "11"] <- "Screens and sedentary lifestyles"
data_topics_with_labels$topic[data_topics_with_labels$topic == "12"] <- "Screentime and literacy"
data_topics_with_labels$topic[data_topics_with_labels$topic == "13"] <- "SciComm"
data_topics_with_labels$topic[data_topics_with_labels$topic == "14"] <- "Cognitive development/ sleep"
data_topics_with_labels$topic[data_topics_with_labels$topic == "15"] <- "Government interventions"
...
p3p4<-p3+p4
#ggsave("sentiment_per_category_per_popular_site.pdf", widt=20, dpi=500)
...
data_with_gamma_details%>% 
  group_by(ID) %>% 
  slice_max(gamma,n=1) %>% #or should it be top 1 terms?
...
#ggsave("prevailing_article_topics_over_time.pdf", width=10, dpi=500)
