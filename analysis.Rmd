...
data_topics_with_labels$topic[data_topics_with_labels$topic == "1"] <- "[1]Skill development"
data_topics_with_labels$topic[data_topics_with_labels$topic == "2"] <- "[2]Education"
data_topics_with_labels$topic[data_topics_with_labels$topic == "3"] <- "[3]Parental concerns"
data_topics_with_labels$topic[data_topics_with_labels$topic == "4"] <- "[4]General tech use"
data_topics_with_labels$topic[data_topics_with_labels$topic == "5"] <- "[5]Gaming"
data_topics_with_labels$topic[data_topics_with_labels$topic == "6"] <- "[6]Increased screentime"
data_topics_with_labels$topic[data_topics_with_labels$topic == "7"] <- "[7]Regulatory applications"
data_topics_with_labels$topic[data_topics_with_labels$topic == "8"] <- "[8]Eye health"
data_topics_with_labels$topic[data_topics_with_labels$topic == "9"] <- "[9]Social media effects on mental health"
data_topics_with_labels$topic[data_topics_with_labels$topic == "10"] <- "[10]Mobile screentime effects"
data_topics_with_labels$topic[data_topics_with_labels$topic == "11"] <- "[11]Screens and sedentary lifestyles"
data_topics_with_labels$topic[data_topics_with_labels$topic == "12"] <- "[12]Screentime and literacy"
data_topics_with_labels$topic[data_topics_with_labels$topic == "13"] <- "[13]SciComm"
data_topics_with_labels$topic[data_topics_with_labels$topic == "14"] <- "[14]Cognitive development/ sleep"
data_topics_with_labels$topic[data_topics_with_labels$topic == "15"] <- "[15]Government interventions"
...
p3p4<-p3+p4
#ggsave("p3p4.pdf", widt=20, dpi=500)
